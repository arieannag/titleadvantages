...
<head>
  ...
  <style>
    ...
    #sendModal label {margin-top: 10px;}
...
<h2 id="titleHeader">Document Toolbox</h2>

<div id="backButton"></div>
  <button class="button" type="button" id="sendModalBtn">Send Documents In Folder</button>


      <div class="toolbox-wrapper" id="toolboxWrapper">

              <div class="toolbox-item" onclick="location.href='cfpb_folder.php'">
                <div class="tool-icon">
              ...
              <div class="toolbox-item" onclick="location.href='consumerguides_folder.php'">
                <div class="tool-icon">
                 <img src="img/folder.png" alt="folder-icon">
                </div>
                 <div class="tool-title">
                <h3>Consumer Guides</h3>
                <p>Folder</p>
                </div>
              </div>
              <div class="toolbox-item" onclick="location.href='countyBldg_folder.php'">
                <div class="tool-icon">
                 <img src="img/folder.png" alt="folder-icon">
                </div>
                 <div class="tool-title">
                <h3>County Bldg &amp; Planning</h3>
                <p>Folder</p>
                </div>
              </div>
              <div class="toolbox-item" onclick="location.href='eduMaterials_folder.php'">
                <div class="tool-icon">
                 <img src="img/folder.png" alt="folder-icon">
                </div>
                 <div class="tool-title">
              ...
              <div class="toolbox-item" onclick="location.href='shortSellInfo_folder.php'">
                <div class="tool-icon">
                 <img src="img/folder.png" alt="folder-icon">
                </div>
                 <div class="tool-title">
                <h3>Foreclosure &amp; Short Sale Information</h3>
                <p>Folder</p>
                </div>
              </div>
              <div class="toolbox-item" onclick="location.href='laws_folder.php'">
                <div class="tool-icon">
                 <img src="img/folder.png" alt="folder-icon">
                </div>
                 <div class="tool-title">
                <h3>Laws &amp; Propositions</h3>
                <p>Folder</p>
                </div>
              </div>
              <div class="toolbox-item" onclick="location.href='myHome_folder.php'">
                <div class="tool-icon">
                 <img src="img/folder.png" alt="folder-icon">
                </div>
                 <div class="tool-title">
              ...
              <div class="toolbox-item" onclick="location.href='resourceLib_folder.php'">
                <div class="tool-icon">
                 <img src="img/folder.png" alt="folder-icon">
                </div>
                 <div class="tool-title">
              ...
              <div class="toolbox-item" onclick="location.href='school_Folder.php'">
                <div class="tool-icon">
                 <img src="img/folder.png" alt="folder-icon">
                </div>
                 <div class="tool-title">
                <h3>School &amp; Community Information</h3>
                <p>Folder</p>
                </div>
              </div>
              <div class="toolbox-item" onclick="location.href='schoolDistrict_folder.php'">
                <div class="tool-icon">
                 <img src="img/folder.png" alt="folder-icon">
                </div>
                 <div class="tool-title">
              ...
              <div class="toolbox-item" onclick="location.href='taxInfo_folder.php'">
                <div class="tool-icon">
                 <img src="img/folder.png" alt="folder-icon">
                </div>
                 <div class="tool-title">
              ...
              <a href="http://octitle.com/askmike.asp" target="_blank">
              <div class="toolbox-item" id="">
                <div class="tool-icon">
                 <img src="img/link.png" alt="link-icon">
                </div>
                <div class="tool-title">
                  <h3>Ask our Legal Department!</h3>
                  <p>Link</p>
               </div>
             </div>
             </a>
              <a href="http://www.octitle.com/avoidwirefraud" target="_blank">
              <div class="toolbox-item" id="">
                <div class="tool-icon">
                 <img src="img/link.png" alt="link-icon">
                </div>
                <div class="tool-title">
                  <h3>Avoiding Wire Fraud</h3>
                  <p>Link</p>
               </div>
             </div>
             </a>
              <a href="http://www.batchgeo.com/" target="_blank">
              <div class="toolbox-item" id="">
                <div class="tool-icon">
                 <img src="img/link.png" alt="link-icon">
                </div>
                <div class="tool-title">
                  <h3>Comparable Maps</h3>
                  <p>Link</p>
               </div>
             </div>
             </a>
              <a href="http://www.google.com/earth/index.html" target="_blank">
              <div class="toolbox-item" id="">
                <div class="tool-icon">
                 <img src="img/link.png" alt="link-icon">
                </div>
              ...
              <a href='mdocs/MilitarySeniorDiscount_generic.pdf' target="_blank";>
              <div class="toolbox-item" id="">
                <div class="tool-icon">
                  <img src="img/pdf.png" alt="file-icon">
                </div>
                <div class="tool-title">
                  <h3>Military &amp;Senior Discount</h3>
                  <p>PDF DOCUMENT</p>
                </div>
              </div>
              </a>
              <a href='mdocs/DesignatedQOZ.pdf' target="_blank";>
              <div class="toolbox-item" id="">
                <div class="tool-icon">
                  <img src="img/pdf.png" alt="file-icon">
                </div>
                <div class="tool-title">
                  <h3>Opp Zone Census Tracts</h3>
                  <p>PDF DOCUMENT</p>
                </div>
              </div>
              </a>
              <a href="http://opzones.ca.gov/" target="_blank">
              <div class="toolbox-item" id="">
                <div class="tool-icon">
                 <img src="img/link.png" alt="link-icon">
                </div>
                <div class="tool-title">
                  <h3>Opp Zones Website</h3>
                  <p>Link</p>
               </div>
             </div>
             </a>
              <a href='mdocs/Pool safety web.pdf' target="_blank";>
              <div class="toolbox-item" id="">
                <div class="tool-icon">
                  <img src="img/pdf.png" alt="file-icon">
                </div>
              ...
              <a href='mdocs/Presale Inspection Reports_revised 2020.pdf' target="_blank";>
              <div class="toolbox-item" id="">
                <div class="tool-icon">
                  <img src="img/pdf.png" alt="file-icon">
                </div>
                <div class="tool-title">
                  <h3>Presale Inspection Reports by City</h3>
                  <p>PDF DOCUMENT</p>
                </div>
              </div>
              </a>
              <a href='mdocs/Rescission_Cal_2021.pdf' target="_blank";>
              <div class="toolbox-item" id="">
                <div class="tool-icon">
                  <img src="img/pdf.png" alt="file-icon">
                </div>
                <div class="tool-title">
                  <h3>Rescission Calendar 2021</h3>
                  <p>PDF DOCUMENT</p>
                </div>
              </div>
              </a>
              <a href='mdocs/Summer Safety Flyer for FB.pdf' target="_blank";>
              <div class="toolbox-item" id="">
                <div class="tool-icon">
                  <img src="img/pdf.png" alt="file-icon">
                </div>
              ...
              <a href='mdocs/Wire Fraud Advisory.pdf' target="_blank";>
              <div class="toolbox-item" id="">
                <div class="tool-icon">
                  <img src="img/pdf.png" alt="file-icon">
                </div>
                <div class="tool-title">
                  <h3>WIRE FRAUD ADVISORY</h3>
                  <p>PDF DOCUMENT</p>
                </div>
              </div>
              </a>
              <a href='mdocs/Yr_Cal_2021.pdf' target="_blank">
              <div class="toolbox-item" id="">
                <div class="tool-icon">
                  <img src="img/pdf.png" alt="file-icon">
                </div>
                <div class="tool-title">
                  <h3>Yearly Calendar 2021</h3>
                  <p>PDF DOCUMENT</p>
                </div>
              </div>
              </a>
      ...
      <div id="sendModal" class="modal">
        ...
        <span class="close" id="sendModalClose">&times;</span>
          ...
          <form action="#">
            ...
            <div id="fileOptions">
                      <input type="checkbox" checked class="file-opt" id="2402" name="2402" value="2402"> <label for="2402" class="doc-inline-label"> Ask our Legal Department!</label> <br>
                      <input type="checkbox" checked class="file-opt" id="7485" name="7485" value="7485"> <label for="7485" class="doc-inline-label"> Avoiding Wire Fraud</label> <br>
                      <input type="checkbox" checked class="file-opt" id="2808" name="2808" value="2808"> <label for="2808" class="doc-inline-label"> Comparable Maps</label> <br>
                      <input type="checkbox" checked class="file-opt" id="2792" name="2792" value="2792"> <label for="2792" class="doc-inline-label"> Google Earth Link</label> <br>
                      <input type="checkbox" checked class="file-opt" id="7642" name="7642" value="7642"> <label for="7642" class="doc-inline-label"> Military &amp;Senior Discount</label> <br>
                      <input type="checkbox" checked class="file-opt" id="8103" name="8103" value="8103"> <label for="8103" class="doc-inline-label"> Opp Zone Census Tracts</label> <br>
                      <input type="checkbox" checked class="file-opt" id="8104" name="8104" value="8104"> <label for="8104" class="doc-inline-label"> Opp Zones Website</label> <br>
                      <input type="checkbox" checked class="file-opt" id="4397" name="4397" value="4397"> <label for="4397" class="doc-inline-label"> Pool Safety</label> <br>
                      <input type="checkbox" checked class="file-opt" id="8380" name="8380" value="8380"> <label for="8380" class="doc-inline-label"> Presale Inspection Reports by City</label> <br>
                      <input type="checkbox" checked class="file-opt" id="8617" name="8617" value="8617"> <label for="8617" class="doc-inline-label"> Rescission Calendar 2021</label> <br>
                      <input type="checkbox" checked class="file-opt" id="6370" name="6370" value="6370"> <label for="6370" class="doc-inline-label"> Summer Safety Tips</label> <br>
                      <input type="checkbox" checked class="file-opt" id="6689" name="6689" value="6689"> <label for="6689" class="doc-inline-label"> WIRE FRAUD ADVISORY</label> <br>
                      <input type="checkbox" checked class="file-opt" id="8616" name="8616" value="8616"> <label for="8616" class="doc-inline-label"> Yearly Calendar 2021</label> <br>
            </div>
            ...
            <button type="button" class="button" type="reset" id="cancelModalSendBtn">Cancel</button>
          </form>
        </div>
      </div>
...
function getAutocompleteItemList(docList){
      ...
      function showSelection(selected){
        ...
        if(selected.type == "file"){
          console.log(selected);
          window.open('docFocus.php?&f=' + selected.itemID);
        }
      }
