...
<body data-new-gr-c-s-check-loaded="14.997.0" data-gr-ext-installed="">
  ...
  <div class="grid-container" id="grid-container">
    ...
    <main>
      ...
      <div class="toolbox-wrapper" id="toolboxWrapper">
        <div class="toolbox-item" id="" onclick="location.href='docToolbox.php'">
          <div class="tool-icon"><img src="img/folder.png" alt="folder-icon"></div>
          <div class="tool-title">
            <h3>Holiday Info.</h3>
            <p>folder</p>
          </div>
        </div><a href="mdocs/Back to School Checklist2.pdf" target="_blank">
        ...
        </a><a href="http://pediatrics.about.com/od/safety/Child_Safety.htm" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Child Safety Tips</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://www.city-data.com/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Crime and City Stats</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="https://www.areavibes.com/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Crime and City Stats 2</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="mdocs/Disaster flyer web.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
        ...
        </a><a href="mdocs/Earthquake Safety Flyer web.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Earthquake &amp; Environ. Safety</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/Earthquake Safety Flyer web.pdf" target="_blank">
        ...
        </a><a href="mdocs/Garage Sale FL.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Garage Sale Tips</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="http://www.helpfulgardener.com/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
        ...
        </a><a href="http://www.howtocleananything.com/professional-cleaning-tips/house-cleaning-tips/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Home Cleaning Tips</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://www.myhomeideas.com/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Home Decorating Ideas</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="mdocs/Seasonal Home Maintenance Checklist web.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
        ...
        </a><a href="http://www.buzzfeed.com/peggy/clever-organizing-tips-to-rein-in-the-chaos#.xd1y6N66v" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
        ...
        </a><a href="http://www.realsimple.com/home-organizing/organizing/home-safety-checklist" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
        ...
        </a><a href="http://www.hgtv.com/landscaping/index.html" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Landscaping Ideas</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://www.safekids.org/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>SafeKids.org</h3>
        ...
        </a><a href="http://www.aplaceformom.com/senior-care-resources/articles/home-safety-tips-for-seniors" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Safety for Seniors</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="mdocs/Spring Cleaning web.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
        ...
        </a><a href="mdocs/ThingsToDo__gen_COVID.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Things to do online</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/Water tip FL web.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
      ...
      <div id="sendModal" class="modal">
        <div class="modal-content" style="text-align: center;">
          ...
          <form action="#">
            ...
            <div id="fileOptions"><input type="checkbox" id="5941" class="file-opt" name="file5941" value="5941" checked=""><label for="5941" class="doc-inline-label">Back to School Checklist</label><br><input type="checkbox" id="3531" class="file-opt" name="link3531" value="3531" checked=""><label for="3531" class="doc-inline-label">Child Safety Tips</label><br><input type="checkbox" id="7547" class="file-opt" name="link7547" value="7547" checked=""><label for="7547" class="doc-inline-label">Crime and City Stats</label><br><input type="checkbox" id="7546" class="file-opt" name="link7546" value="7546" checked=""><label for="7546" class="doc-inline-label">Crime and City Stats 2</label><br><input type="checkbox" id="5463" class="file-opt" name="file5463" value="5463" checked=""><label for="5463" class="doc-inline-label">Disaster Preparedness</label><br><input type="checkbox" id="4294" class="file-opt" name="file4294" value="4294" checked=""><label for="4294" class="doc-inline-label">Earthquake &amp; Environ. Safety</label><br><input type="checkbox" id="3553" class="file-opt" name="file3553" value="3553" checked=""><label for="3553" class="doc-inline-label">Earthquake Safety</label><br><input type="checkbox" id="4418" class="file-opt" name="file4418" value="4418" checked=""><label for="4418" class="doc-inline-label">Garage Sale Tips</label><br><input type="checkbox" id="3526" class="file-opt" name="link3526" value="3526" checked=""><label for="3526" class="doc-inline-label">Gardening Tips</label><br><input type="checkbox" id="3522" class="file-opt" name="link3522" value="3522" checked=""><label for="3522" class="doc-inline-label">Home Cleaning Tips</label><br><input type="checkbox" id="3528" class="file-opt" name="link3528" value="3528" checked=""><label for="3528" class="doc-inline-label">Home Decorating Ideas</label><br><input type="checkbox" id="7021" class="file-opt" name="file7021" value="7021" checked=""><label for="7021" class="doc-inline-label">Home Maintenance Checklist</label><br><input type="checkbox" id="5788" class="file-opt" name="link5788" value="5788" checked=""><label for="5788" class="doc-inline-label">Home Organization Tips</label><br><input type="checkbox" id="5787" class="file-opt" name="link5787" value="5787" checked=""><label for="5787" class="doc-inline-label">Home Safety Checklist</label><br><input type="checkbox" id="3527" class="file-opt" name="link3527" value="3527" checked=""><label for="3527" class="doc-inline-label">Landscaping Ideas</label><br><input type="checkbox" id="5484" class="file-opt" name="link5484" value="5484" checked=""><label for="5484" class="doc-inline-label">SafeKids.org</label><br><input type="checkbox" id="5786" class="file-opt" name="link5786" value="5786" checked=""><label for="5786" class="doc-inline-label">Safety for Seniors</label><br><input type="checkbox" id="6372" class="file-opt" name="file6372" value="6372" checked=""><label for="6372" class="doc-inline-label">Spring Cleaning Tips</label><br><input type="checkbox" id="8308" class="file-opt" name="file8308" value="8308" checked=""><label for="8308" class="doc-inline-label">Things to do online</label><br><input type="checkbox" id="5841" class="file-opt" name="file5841" value="5841" checked=""><label for="5841" class="doc-inline-label">Water Conservation Tips</label><br></div>
