...
<body>
  ...
  <div class="grid-container" id="grid-container">
    ...
    <main>
      ...
      <div class="toolbox-wrapper" id="toolboxWrapper">
        ...
        <a class="a-flex" href='redocuments/affdojt.doc' target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Affidavit - Death of Joint Tenant</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/affdos.docx' target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Affidavit - Death of Spouse</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/affcomm.docx' target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Affidavit - Death of Spouse (Comm. Prop. with Right of Survivorship)</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/affdotr.docx' target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Affidavit - Death of Trustee</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/orassdot.docx' target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Assignment of Deed of Trust</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/orcadot.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Corporation Assignment of Deed of Trust</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/orcertot.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Certification of Trustee</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/confofconv.pdf' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Confirmation of Conveyance (Affidavit of Uninsured Deed)</h3>
              <p>PDF DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/orcorpgd.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Corporation Grant Deed</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/decabhom.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Declaration of Abandonment of Declared Homestead</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/homested.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Declaration of Homestead (Individual as Declared Owner)</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/homespou.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Declaration of Homestead (Spouses as Declared Owners)</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/oreadeed.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
        ...
        <a class="a-flex" href='redocuments/orfrecon.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Full Reconveyance</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/orgrdeed.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
        ...
        <a class="a-flex" href='redocuments/istd.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Interspousal Transfer Deed</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/itgdcomm.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Interspousal Transfer Grant Deed (Comm. Prop. with Right of Survivorship)</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/orjtgd.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Joint Tenancy Grant Deed</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/NotaryAcknowledgment.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
        ...
        <a class="a-flex" href='redocuments/inote_ie.doc' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Note Secured by Deed of Trust (Installment note, Interest Extra)</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/orprecon.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Partial Reconveyance</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/partgd.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Partnership Grant Deed</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/pcor.pdf' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Preliminary Change of Ownership</h3>
              <p>PDF DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/pnoteuns.doc' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Promissory Note (Unsecured)</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/qcdeed.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
        ...
        <a class="a-flex" href='redocuments/orreq4fr.doc' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Request for Full Reconveyance</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/rfnotice.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Request For Notice</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/RevocableTransferonDeathDeed.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Revocable Transfer on Death Deed</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/RevocationofTransferUponDeathDeed.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Revocation of Transfer Upon Death Deed</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/orsfdtar.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Short Form Deed of Trust and Assignment of Rents, (Orange Coast Title Company, TTEE)</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/orsfdtaroctsoca.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Short Form Deed of Trust and Assignment of Rents, ( (Orange Coast Title Company of Southern California, TTEE)</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/si.pdf' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
        ...
        <a class="a-flex" href='redocuments/SIspanishFill-InOCT.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
        ...
        <a class="a-flex" href='redocuments/str8note.doc' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
        ...
        <a class="a-flex" href='redocuments/str8dosc.doc' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Straight Note (Due On Sale Clause)</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/orsotdor.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Substitution of Trustee and Deed of Reconveyance</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/orsubotr.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Substitution of Trustee</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
        <a class="a-flex" href='redocuments/orttdeed.docx' target="_blank" ;>
          <div class="toolbox-item" id="">
            <div class="tool-icon">
              <img src="img/pdf.png" alt="file-icon">
            </div>
            <div class="tool-title">
              <h3>Trust Transfer Deed</h3>
              <p>JPG DOCUMENT</p>
            </div>
          </div>
        </a>
  ...
  <script>
    ...
    var user = "ASP._Page_nd1c_REDocs_cshtml+User"
    ...
    function generateOptions(data) {
      ...
      var itemObjects = data.itemObjects;

      var options = "";
      for (var i = 0; i < itemObjects.length; i++) {
        if (itemObjects[i].itemtype === "file") {
          options += '<a href="docfocus.php?f=' + itemObjects[i].itemID + '">';
    ...
    function fetchData() {
      fetch("../../mobileredocumentslistAPI.asp?o=" + userOcode)
        .then((response) => {
    ...
    function showSelection(selected) {
      ...
      if (selected.type == "folder") {
        updateDocsForFolder(selected.linkAddress);
      }
      ...
      if (selected.type == "file") {
        window.open('https://www.titleadvantage.com/nd1c/docFocus.php?type=redoc&u=' + username + '&id=' + memberID + '&f=' + selected.itemID);
      }
    }
  </script>
