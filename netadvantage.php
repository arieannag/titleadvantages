  ...
  <div class="grid-container" id="grid-container">
    ...
    <main>
      ...
      <div class="netAdvantageIcons" id="netAdvantageIcons">
        <a href="quickBuyer.php">
          <div class="netAdvItem">
            <img src="img/netBuyer.png" alt="Net Advantage Buyer">
            <p>
              Quick Net Sheet <br>
              <b>BUYER</b>
            </p>
        ...
        <a href="quickRefi.php">
          <div class="netAdvItem">
            <img src="img/netRefi.png" alt="Net Advantage Refinance">
            <p>
              Quick Net Sheet <br>
              <b>REFINANCE</b>
            </p>
        ...
        <a href="quickSeller.php">
          <div class="netAdvItem">
            <img src="img/netSeller.png" alt="Net Advantage Seller">
            <p>
              Quick Net Sheet <br>
              <b>SELLER</b>
            </p>
        ...
        <a href="netAdvHistory.php">
          <div class="netAdvItem">
            <img src="img/netHistory.png" alt="Net Advantage Seller">
            <p>
              Net Sheet <br>
              <b>HISTORY</b>
            </p>
        ...
        <a href="properties.php#yourProperties">
          <div class="netAdvItem">
            <img src="img/netPropList.png" alt="Net Advantage Seller">
            <p>
              Standard Net Sheet <br>
              <b>FROM YOUR PROPERTIES</b>
            </p>
          </div>
        </a>
        <a href="newproperty.php">
          <div class="netAdvItem">
            <img src="img/netNewProp.png" alt="Net Advantage Seller">
            <p>
              Standard Net Sheet <br>
              <b>NEW PROPERTY</b>
            </p>
      ...
      <BR>
      <P>
        <a href="netadvantagedefaults.php">Net Advantage Settings</a>
      </P>
