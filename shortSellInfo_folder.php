...
<body data-new-gr-c-s-check-loaded="14.997.0" data-gr-ext-installed="">
  ...
  <div class="grid-container" id="grid-container">
    ...
    <main>
      ...
      <h2 id="titleHeader">Foreclosure &amp; Short Sale Information</h2>
      ...
      <div class="toolbox-wrapper" id="toolboxWrapper">
        <a href="mdocs/Cal GlossaryOfTerms.pdf" target="_blank">
        ...
        </a><a href="mdocs/Short sale  foreclosure crediit.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>How SS &amp; Foreclosures Effect Your Credit</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="https://www.hud.gov/program_offices/housing/sfh/nsc/lossmit" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Loss Mitigation for FHA</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="mdocs/Short Sale Info.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Short Sale Info.</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/Short sale Q&A.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Short Sale Q&amp;A</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/Short sale vs REO.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Short Sale vs REO</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/Trustee Timeline web.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Trustee Timeline</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/Foreclosure.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Understanding Foreclosure</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a></div>
      ...
      <div id="sendModal" class="modal">
        <div class="modal-content" style="text-align: center;">
          ...
          <form action="#">
            ...
            <div id="fileOptions"><input type="checkbox" id="2445" class="file-opt" name="file2445" value="2445" checked=""><label for="2445" class="doc-inline-label">Glossary of Terms</label><br><input type="checkbox" id="2446" class="file-opt" name="file2446" value="2446" checked=""><label for="2446" class="doc-inline-label">How SS &amp; Foreclosures Effect Your Credit</label><br><input type="checkbox" id="7393" class="file-opt" name="link7393" value="7393" checked=""><label for="7393" class="doc-inline-label">Loss Mitigation for FHA</label><br><input type="checkbox" id="2444" class="file-opt" name="file2444" value="2444" checked=""><label for="2444" class="doc-inline-label">Short Sale Info.</label><br><input type="checkbox" id="2442" class="file-opt" name="file2442" value="2442" checked=""><label for="2442" class="doc-inline-label">Short Sale Q&amp;A</label><br><input type="checkbox" id="2443" class="file-opt" name="file2443" value="2443" checked=""><label for="2443" class="doc-inline-label">Short Sale vs REO</label><br><input type="checkbox" id="2440" class="file-opt" name="file2440" value="2440" checked=""><label for="2440" class="doc-inline-label">Trustee Timeline</label><br><input type="checkbox" id="2441" class="file-opt" name="file2441" value="2441" checked=""><label for="2441" class="doc-inline-label">Understanding Foreclosure</label><br></div>
