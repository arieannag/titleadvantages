...
<body data-new-gr-c-s-check-loaded="14.997.0" data-gr-ext-installed="">
  ...
  <div class="grid-container" id="grid-container">
    ...
    <main>
      ...
      <h2 id="titleHeader">Tax Information</h2>
      ...
      <div class="toolbox-wrapper" id="toolboxWrapper"><a href="http://www.californiataxdata.com/A_Home/index.asp" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>California Tax Data</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="mdocs/CapitalGains_flyer.pdf" target="_blank">
          <div class="toolbox-item" id="">
        ...
        </a><a href="mdocs/Homeowners prop tax exemption all.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Homeowners Tax Exemption</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/Tax Roll Explantion.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>How to Read A Tax Roll</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="http://www.imperialcounty.net/Assessor/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Imperial County Assessor</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="https://assessor.lacounty.gov/forms-2/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Los Angeles Co. Tax Assessor</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://ocgov.com/gov/assessor/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Orange Co. Tax Assessor</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="mdocs/2020_Propertytax_Impound_flyer.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Property Tax Schedule &amp; Impounds</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/Prop 13 rev_2019_2.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Proposition 13</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="http://www.riversideacr.com/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Riverside Co. Tax Assessor</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://www.co.san-bernardino.ca.us/assessor/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>San Bernardino Co. Tax Assessor</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://www.sdtreastax.com/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>San Diego Co. Tax Assessor</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="mdocs/Supplemntal Tax FL_web_20.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Supplemental Taxes</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/Tax Sale Auction web.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Tax Sale Auction Info</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/County & City Transfer Taxes CA_web2021.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Transfer Tax Rates for CA</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="http://assessor.countyofventura.org/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Ventura Co. Tax Assessor</h3>
              <p>link</p>
            </div>
          </div>
        </a></div>
      ...
      <div id="sendModal" class="modal">
        <div class="modal-content" style="text-align: center;">
          ...
          <form action="#">
            ...
            <div id="fileOptions"><input type="checkbox" id="4039" class="file-opt" name="link4039" value="4039" checked=""><label for="4039" class="doc-inline-label">California Tax Data</label><br><input type="checkbox" id="8656" class="file-opt" name="file8656" value="8656" checked=""><label for="8656" class="doc-inline-label">Capital Gains Taxes</label><br><input type="checkbox" id="2397" class="file-opt" name="file2397" value="2397" checked=""><label for="2397" class="doc-inline-label">Homeowners Tax Exemption</label><br><input type="checkbox" id="3490" class="file-opt" name="file3490" value="3490" checked=""><label for="3490" class="doc-inline-label">How to Read A Tax Roll</label><br><input type="checkbox" id="3555" class="file-opt" name="link3555" value="3555" checked=""><label for="3555" class="doc-inline-label">Imperial County Assessor</label><br><input type="checkbox" id="2434" class="file-opt" name="link2434" value="2434" checked=""><label for="2434" class="doc-inline-label">Los Angeles Co. Tax Assessor</label><br><input type="checkbox" id="4122" class="file-opt" name="link4122" value="4122" checked=""><label for="4122" class="doc-inline-label">Orange Co. Tax Assessor</label><br><input type="checkbox" id="8658" class="file-opt" name="file8658" value="8658" checked=""><label for="8658" class="doc-inline-label">Property Tax Schedule &amp; Impounds</label><br><input type="checkbox" id="7895" class="file-opt" name="file7895" value="7895" checked=""><label for="7895" class="doc-inline-label">Proposition 13</label><br><input type="checkbox" id="2433" class="file-opt" name="link2433" value="2433" checked=""><label for="2433" class="doc-inline-label">Riverside Co. Tax Assessor</label><br><input type="checkbox" id="2435" class="file-opt" name="link2435" value="2435" checked=""><label for="2435" class="doc-inline-label">San Bernardino Co. Tax Assessor</label><br><input type="checkbox" id="2436" class="file-opt" name="link2436" value="2436" checked=""><label for="2436" class="doc-inline-label">San Diego Co. Tax Assessor</label><br><input type="checkbox" id="8344" class="file-opt" name="file8344" value="8344" checked=""><label for="8344" class="doc-inline-label">Supplemental Taxes</label><br><input type="checkbox" id="5586" class="file-opt" name="file5586" value="5586" checked=""><label for="5586" class="doc-inline-label">Tax Sale Auction Info</label><br><input type="checkbox" id="8682" class="file-opt" name="file8682" value="8682" checked=""><label for="8682" class="doc-inline-label">Transfer Tax Rates for CA</label><br><input type="checkbox" id="2437" class="file-opt" name="link2437" value="2437" checked=""><label for="2437" class="doc-inline-label">Ventura Co. Tax Assessor</label><br></div>
