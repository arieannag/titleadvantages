...
<h2 id="titleHeader">School District Information</h2>

<div id="backButton"><button class="button" onclick="location.href='docToolbox.php'">Return to Main Folder</button></div>
  <button class="button" type="button" id="sendModalBtn" style="display: none;">Send Documents In Folder</button>


      <div class="toolbox-wrapper" id="toolboxWrapper"></div>
      ...
      <div id="sendModal" class="modal">
        ...
        <span class="close" id="sendModalClose">×</span>
          ...
          <form action="#">
            ...
            <div id="fileOptions"><input type="checkbox" id="2402" class="file-opt" name="link2402" value="2402" checked=""><label for="2402" class="doc-inline-label">Ask our Legal Department!</label><br><input type="checkbox" id="7485" class="file-opt" name="link7485" value="7485" checked=""><label for="7485" class="doc-inline-label">Avoiding Wire Fraud</label><br><input type="checkbox" id="2808" class="file-opt" name="link2808" value="2808" checked=""><label for="2808" class="doc-inline-label">Comparable Maps</label><br><input type="checkbox" id="2792" class="file-opt" name="link2792" value="2792" checked=""><label for="2792" class="doc-inline-label">Google Earth Link</label><br><input type="checkbox" id="7642" class="file-opt" name="file7642" value="7642" checked=""><label for="7642" class="doc-inline-label">Military &amp;Senior Discount</label><br><input type="checkbox" id="8103" class="file-opt" name="file8103" value="8103" checked=""><label for="8103" class="doc-inline-label">Opp Zone Census Tracts</label><br><input type="checkbox" id="8104" class="file-opt" name="link8104" value="8104" checked=""><label for="8104" class="doc-inline-label">Opp Zones Website</label><br><input type="checkbox" id="4397" class="file-opt" name="file4397" value="4397" checked=""><label for="4397" class="doc-inline-label">Pool Safety</label><br><input type="checkbox" id="8380" class="file-opt" name="file8380" value="8380" checked=""><label for="8380" class="doc-inline-label">Presale Inspection Reports by City</label><br><input type="checkbox" id="8617" class="file-opt" name="file8617" value="8617" checked=""><label for="8617" class="doc-inline-label">Rescission Calendar 2021</label><br><input type="checkbox" id="6370" class="file-opt" name="file6370" value="6370" checked=""><label for="6370" class="doc-inline-label">Summer Safety Tips</label><br><input type="checkbox" id="6689" class="file-opt" name="file6689" value="6689" checked=""><label for="6689" class="doc-inline-label">WIRE FRAUD ADVISORY</label><br><input type="checkbox" id="8616" class="file-opt" name="file8616" value="8616" checked=""><label for="8616" class="doc-inline-label">Yearly Calendar 2021</label><br></div>
...
<ul id="ui-id-1" tabindex="0" class="ui-menu ui-widget ui-widget-content ui-autocomplete highlight ui-front" style="display: none;"></ul><div role="status" aria-live="assertive" aria-relevant="additions" class="ui-helper-hidden-accessible"></div></body></html>