...
<body data-new-gr-c-s-check-loaded="14.997.0" data-gr-ext-installed="">
  ...
  <div class="grid-container" id="grid-container">
    ...
    <main>
      ...
      <h2 id="titleHeader">Real Estate Resources</h2>
      ...
      <div class="toolbox-wrapper" id="toolboxWrapper"><a href="mdocs/brkrcomp.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Broker Compliance Evaluation Manual</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="http://www.orea.ca.gov/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Bureau of RE Appraisers</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://www.car.org/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>CA Assoc. of Realtors</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://www.dre.ca.gov/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>CA Bureau of RE</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://www.homeinspections-usa.com/main/insp/home_inspectors/California" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Find an Inspector</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="mdocs/re7.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Mtg Loan Broker Compliance Manual</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="http://www.realtor.org/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>National Assoc. of Realtors</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://dre.ca.gov/Publications/ReferenceBook.html" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Real Estate Guide Book</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://realtormag.realtor.org/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>REALTORmag</h3>
        ...
        </a><a href="http://www.car.org/tools/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Zipforms</h3>
      ...
      <div id="sendModal" class="modal">
        <div class="modal-content" style="text-align: center;">
          ...
          <form action="#">
            ...
            <div id="fileOptions"><input type="checkbox" id="5272" class="file-opt" name="file5272" value="5272" checked=""><label for="5272" class="doc-inline-label">Broker Compliance Evaluation Manual</label><br><input type="checkbox" id="5265" class="file-opt" name="link5265" value="5265" checked=""><label for="5265" class="doc-inline-label">Bureau of RE Appraisers</label><br><input type="checkbox" id="5263" class="file-opt" name="link5263" value="5263" checked=""><label for="5263" class="doc-inline-label">CA Assoc. of Realtors</label><br><input type="checkbox" id="5262" class="file-opt" name="link5262" value="5262" checked=""><label for="5262" class="doc-inline-label">CA Bureau of RE</label><br><input type="checkbox" id="5268" class="file-opt" name="link5268" value="5268" checked=""><label for="5268" class="doc-inline-label">Find an Inspector</label><br><input type="checkbox" id="5271" class="file-opt" name="file5271" value="5271" checked=""><label for="5271" class="doc-inline-label">Mtg Loan Broker Compliance Manual</label><br><input type="checkbox" id="5264" class="file-opt" name="link5264" value="5264" checked=""><label for="5264" class="doc-inline-label">National Assoc. of Realtors</label><br><input type="checkbox" id="5270" class="file-opt" name="link5270" value="5270" checked=""><label for="5270" class="doc-inline-label">Real Estate Guide Book</label><br><input type="checkbox" id="5273" class="file-opt" name="link5273" value="5273" checked=""><label for="5273" class="doc-inline-label">REALTORmag</label><br><input type="checkbox" id="5266" class="file-opt" name="link5266" value="5266" checked=""><label for="5266" class="doc-inline-label">Zipforms</label><br></div>
