...
<body data-new-gr-c-s-check-loaded="14.997.0" data-gr-ext-installed="">
  ...
  <div class="grid-container" id="grid-container">
    ...
    <main>
      ...
      <div class="toolbox-wrapper" id="toolboxWrapper"><a href="http://www.consumerfinance.gov/" target="_blank">
        ...
        </a><a href="mdocs/TRID Cal rev date.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Closing Disclosure Delivery Calendar</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/Home Loan Tool Kit English web.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Home Loan Toolkit English</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/Home Loan Toolkit Spanish web.pdf"  target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Home Loan Toolkit Spanish</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/SSAE letter flyer.pdf"  target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>OCT Compliance Letter</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/Closing Disclosure.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
        ...
        </a><a href="mdocs/Loan Estimate.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Sample Loan Estimate</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/TRId Power Point date rev2.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>TRID Power Point</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/What is CFPB web.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>What is CFPB?</h3>
      ...
      <div id="sendModal" class="modal">
        <div class="modal-content" style="text-align: center;">
          ...
          <form action="#">
            ...
            <div id="fileOptions"><input type="checkbox" id="5815" class="file-opt" name="link5815" value="5815" checked=""><label for="5815" class="doc-inline-label">CFPB official website</label><br><input type="checkbox" id="5908" class="file-opt" name="file5908" value="5908" checked=""><label for="5908" class="doc-inline-label">Closing Disclosure Delivery Calendar</label><br><input type="checkbox" id="5944" class="file-opt" name="file5944" value="5944" checked=""><label for="5944" class="doc-inline-label">Home Loan Toolkit English</label><br><input type="checkbox" id="5945" class="file-opt" name="file5945" value="5945" checked=""><label for="5945" class="doc-inline-label">Home Loan Toolkit Spanish</label><br><input type="checkbox" id="5812" class="file-opt" name="file5812" value="5812" checked=""><label for="5812" class="doc-inline-label">OCT Compliance Letter</label><br><input type="checkbox" id="5844" class="file-opt" name="file5844" value="5844" checked=""><label for="5844" class="doc-inline-label">Sample Closing Disclosure</label><br><input type="checkbox" id="5845" class="file-opt" name="file5845" value="5845" checked=""><label for="5845" class="doc-inline-label">Sample Loan Estimate</label><br><input type="checkbox" id="5911" class="file-opt" name="file5911" value="5911" checked=""><label for="5911" class="doc-inline-label">TRID Power Point</label><br><input type="checkbox" id="5813" class="file-opt" name="file5813" value="5813" checked=""><label for="5813" class="doc-inline-label">What is CFPB?</label><br></div>
