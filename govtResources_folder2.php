...
<body data-new-gr-c-s-check-loaded="14.997.0" data-gr-ext-installed="">
  ...
  <div class="grid-container" id="grid-container">
    ...
    <main>
      ...
      <h2 id="titleHeader">Government Resources</h2>
      ...
      <div class="toolbox-wrapper" id="toolboxWrapper"><a href="http://www.dre.ca.gov/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>CA Bureau of Real Estate</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://www.cdc.gov/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>CDC</h3>
        ...
        </a><a href="http://www.consumerfinance.gov/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>CFPB Official Website</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://www.epa.gov/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>EPA</h3>
        ...
        </a><a href="http://www.fema.gov/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>FEMA</h3>
        ...
        </a><a href="https://entp.hud.gov/idapp/html/condlook.cfm" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>FHA Approved Condos</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="https://www.heroprogram.com/hlp-landing" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>HERO Program info</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://portal.hud.gov/hudportal/HUD" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>HUD</h3>
        ...
        </a><a href="https://vip.vba.va.gov/portal/VBAH/VBAHome/condopudsearch?paf_portalId=default&amp;paf_communityId=100002&amp;paf_pageId=500002&amp;paf_dm=full&amp;paf_gear_id=800001&amp;paf_gm=content&amp;paf_ps=_rp_800001_stateCode%3D1_CA%26_rp_800001_regionalOff" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>VA Approved Condo Search</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="mdocs/What-is-PACE.pdf" target="_blank">
          <div class="toolbox-item" id="">
      ...
      <div id="sendModal" class="modal">
        <div class="modal-content" style="text-align: center;">
          ...
          <form action="#">
            ...
            <div id="fileOptions"><input type="checkbox" id="5211" class="file-opt" name="link5211" value="5211" checked=""><label for="5211" class="doc-inline-label">CA Bureau of Real Estate</label><br><input type="checkbox" id="5107" class="file-opt" name="link5107" value="5107" checked=""><label for="5107" class="doc-inline-label">CDC</label><br><input type="checkbox" id="5806" class="file-opt" name="link5806" value="5806" checked=""><label for="5806" class="doc-inline-label">CFPB Official Website</label><br><input type="checkbox" id="5106" class="file-opt" name="link5106" value="5106" checked=""><label for="5106" class="doc-inline-label">EPA</label><br><input type="checkbox" id="5105" class="file-opt" name="link5105" value="5105" checked=""><label for="5105" class="doc-inline-label">FEMA</label><br><input type="checkbox" id="4114" class="file-opt" name="link4114" value="4114" checked=""><label for="4114" class="doc-inline-label">FHA Approved Condos</label><br><input type="checkbox" id="7345" class="file-opt" name="link7345" value="7345" checked=""><label for="7345" class="doc-inline-label">HERO Program info</label><br><input type="checkbox" id="5104" class="file-opt" name="link5104" value="5104" checked=""><label for="5104" class="doc-inline-label">HUD</label><br><input type="checkbox" id="4121" class="file-opt" name="link4121" value="4121" checked=""><label for="4121" class="doc-inline-label">VA Approved Condo Search</label><br><input type="checkbox" id="5789" class="file-opt" name="file5789" value="5789" checked=""><label for="5789" class="doc-inline-label">What is PACE?</label><br></div>
