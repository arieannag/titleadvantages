...
<body data-new-gr-c-s-check-loaded="14.997.0" data-gr-ext-installed="">
  ...
  <div class="grid-container" id="grid-container">
    ...
    <main>
      ...
      <h2 id="titleHeader">Your Training Place</h2>
      ...
      <div class="toolbox-wrapper" id="toolboxWrapper"><a href="mdocs/Farming for Success PPT.pdf" target="_blank">
        ...
        </a><a href="https://www.youtube.com/watch?v=gx0YDvySIrs" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Mobile App 2.0 for iOS</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="mdocs/Binder PPT.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>The Binder</h3>
        ...
        </a><a href="mdocs/How to read A Prelim PPT.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>The Preliminary Report</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a></div>
      ...
      <div id="sendModal" class="modal">
        <div class="modal-content" style="text-align: center;">
          ...
          <form action="#">
            ...
            <div id="fileOptions"><input type="checkbox" id="5951" class="file-opt" name="file5951" value="5951" checked=""><label for="5951" class="doc-inline-label">Farming 101</label><br><input type="checkbox" id="5980" class="file-opt" name="link5980" value="5980" checked=""><label for="5980" class="doc-inline-label">Mobile App 2.0 for iOS</label><br><input type="checkbox" id="5950" class="file-opt" name="file5950" value="5950" checked=""><label for="5950" class="doc-inline-label">The Binder</label><br><input type="checkbox" id="5952" class="file-opt" name="file5952" value="5952" checked=""><label for="5952" class="doc-inline-label">The Preliminary Report</label><br></div>
