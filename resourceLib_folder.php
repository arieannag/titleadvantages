...
<body data-new-gr-c-s-check-loaded="14.997.0" data-gr-ext-installed="">
  ...
  <div class="grid-container" id="grid-container">
    ...
    <main>
      ...
      <h2 id="titleHeader">Resource Library</h2>
      ...
      <div class="toolbox-wrapper" id="toolboxWrapper">
        <div class="toolbox-item" id="" onclick="location.href='dataResources_folder2.php'">
        ...
        <div class="toolbox-item" id="" onclick="location.href='govtResources_folder2.php'">
          <div class="tool-icon"><img src="img/folder.png" alt="folder-icon"></div>
          <div class="tool-title">
        ...
        <div class="toolbox-item" id="" onclick="location.href='realEstate_folder2.php'">
          <div class="tool-icon"><img src="img/folder.png" alt="folder-icon"></div>
          <div class="tool-title">
        ...
        <div class="toolbox-item" id="" onclick="location.href='yourTraining_folder2.php'">
          <div class="tool-icon"><img src="img/folder.png" alt="folder-icon"></div>
          <div class="tool-title">
            <h3>Your Training Place</h3>
            <p>folder</p>
          </div>
        </div><a href="http://office.microsoft.com/en-us/templates/results.aspx?qu=real+estate&amp;ex=1" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Postcard &amp; Flyer Templates</h3>
              <p>link</p>
            </div>
          </div>
        </a>
      ...
      <div id="sendModal" class="modal">
        <div class="modal-content" style="text-align: center;">
          ...
          <form action="#">
            ...
            <div id="fileOptions"><input type="checkbox" id="4354" class="file-opt" name="link4354" value="4354" checked=""><label for="4354" class="doc-inline-label">Postcard &amp; Flyer Templates</label><br></div>
