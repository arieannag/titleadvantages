...
<body data-new-gr-c-s-check-loaded="14.997.0" data-gr-ext-installed="">
  ...
  <div class="grid-container" id="grid-container">
    ...
    <main>
      ...
      <h2 id="titleHeader">Laws &amp; Propositions</h2>
      ...
      <div class="toolbox-wrapper" id="toolboxWrapper">
        <div class="toolbox-item" id="" onclick="location.href='rentControl_folder2.php'">
          <div class="tool-icon"><img src="img/folder.png" alt="folder-icon"></div>
          <div class="tool-title">
            <h3>Rent Control CA</h3>
            <p>folder</p>
          </div>
        </div><a href="mdocs/AB 139  web.pdf" target="_blank">
        ...
        </a><a href="mdocs/Death Deed Q&A.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>AB 139 Death Deed Q&amp;A</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/AB 646 web 3.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>AB 646 - Flood Hazard Disclosure</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/AB 957 Buyers Choice Act.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>AB 957 Buyer's Choice Act</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/FinCEN GTO_web_2021_2.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
        ...
        </a><a href="mdocs/Housing Assistance Program 11.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>HAP - Housing Assistance Program</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/Carbon monoxide2.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Law on Carbon Monoxide Detectors</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/Mills Act.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Mills Act - Historic Preservation</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/2021 New Laws.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>New Laws for 2021</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/Prop19_flyer_2020_2.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Prop 19 effective April 2021</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/Prop 110 rev 2015.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Proposition 110</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/Prop 13 rev_2019.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
        ...
        </a><a href="mdocs/Prop 58 & 193.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Proposition 58 &amp; 193</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/SB 2.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>SB 2 Recording Fees</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/SB 931, SB 458, Civil Code 580e.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Senate Bill 931 &amp; 458</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a>
      ...
      <div id="sendModal" class="modal">
        <div class="modal-content" style="text-align: center;">
          ...
          <form action="#">
            ...
            <div id="fileOptions"><input type="checkbox" id="6140" class="file-opt" name="file6140" value="6140" checked=""><label for="6140" class="doc-inline-label">AB 139</label><br><input type="checkbox" id="6246" class="file-opt" name="file6246" value="6246" checked=""><label for="6246" class="doc-inline-label">AB 139 Death Deed Q&amp;A</label><br><input type="checkbox" id="7097" class="file-opt" name="file7097" value="7097" checked=""><label for="7097" class="doc-inline-label">AB 646 - Flood Hazard Disclosure</label><br><input type="checkbox" id="2909" class="file-opt" name="file2909" value="2909" checked=""><label for="2909" class="doc-inline-label">AB 957 Buyer's Choice Act</label><br><input type="checkbox" id="8671" class="file-opt" name="file8671" value="8671" checked=""><label for="8671" class="doc-inline-label">FinCEN Information</label><br><input type="checkbox" id="2939" class="file-opt" name="file2939" value="2939" checked=""><label for="2939" class="doc-inline-label">HAP - Housing Assistance Program</label><br><input type="checkbox" id="2408" class="file-opt" name="file2408" value="2408" checked=""><label for="2408" class="doc-inline-label">Law on Carbon Monoxide Detectors</label><br><input type="checkbox" id="7884" class="file-opt" name="file7884" value="7884" checked=""><label for="7884" class="doc-inline-label">Mills Act - Historic Preservation</label><br><input type="checkbox" id="8618" class="file-opt" name="file8618" value="8618" checked=""><label for="8618" class="doc-inline-label">New Laws for 2021</label><br><input type="checkbox" id="8557" class="file-opt" name="file8557" value="8557" checked=""><label for="8557" class="doc-inline-label">Prop 19 effective April 2021</label><br><input type="checkbox" id="5859" class="file-opt" name="file5859" value="5859" checked=""><label for="5859" class="doc-inline-label">Proposition 110</label><br><input type="checkbox" id="7894" class="file-opt" name="file7894" value="7894" checked=""><label for="7894" class="doc-inline-label">Proposition 13</label><br><input type="checkbox" id="2403" class="file-opt" name="file2403" value="2403" checked=""><label for="2403" class="doc-inline-label">Proposition 58 &amp; 193</label><br><input type="checkbox" id="7093" class="file-opt" name="file7093" value="7093" checked=""><label for="7093" class="doc-inline-label">SB 2 Recording Fees</label><br><input type="checkbox" id="2638" class="file-opt" name="file2638" value="2638" checked=""><label for="2638" class="doc-inline-label">Senate Bill 931 &amp; 458</label><br></div>
