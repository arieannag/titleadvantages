...
<body>
  ...
  <div class="grid-container" id="grid-container">
    ...
    <main>
      <h2>Connecting to Lists and Leads</h2>

      <center>
        <P></P>
        We will try to automatically log you in to our Lists and Leads portal using the single click below.
        <BR>
        <P></P>
        <P></P>
        <P></P>
        <div style="height: 50px;"> </div>
        <input type="button" onclick="launchSite();" value=" Launch Lists and Leads Now " style="padding:10px; font-size: 20px;">
        <P>

        </P>
        <div style="color:#ffffff; font-size:2px; margin: 20px;">
          https://www.titleadvantage.com/mobilebkfsgetkey.asp?id=293272&u=Kyle Jonas&ocode=oct
        </div>
        <BR>
      </center>
    </main>
  ...
  <script>
    function launchSite() {
      var newsite = "https://www.titlepro247.com/Logon.aspx?key=85868b8b-7858-435c-a88b-d4f339543a1c";
