...
<body data-new-gr-c-s-check-loaded="14.997.0" data-gr-ext-installed="">
  ...
  <div class="grid-container" id="grid-container">
    ...
    <main>
      ...
      <h2 id="titleHeader">County Bldg &amp; Planning</h2>
      ...
      <div class="toolbox-wrapper" id="toolboxWrapper"><a href="http://www.icpds.com/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Imperial Co. Planning &amp; Dev.</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://esps.kerndsa.com/building-inspection" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Kern Co. Bldg. Inspection</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://pcd.kerndsa.com/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Kern Co. Planning &amp; Comm. Dev.</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://dpw.lacounty.gov/bsd/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>LA County Dept. of Public Works</h3>
              <p>link</p>
            </div>
          </div>
          ...
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>OC Bldg. &amp; Planning</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://www.rctlma.org/building/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Riverside Co. Bldg. &amp; Safety</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://cms.sbcounty.gov/lus/BuildingSafety.aspx" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>San Bernardino Bldg. &amp; Safety</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://www.sdcounty.ca.gov/dpw/index.html" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>San Diego Co. Dept. of Public Works</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://sbcountyplanning.org/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Santa Barbara Co. Planning</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://www.ventura.org/rma/build_safe/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Ventura Co. Bldg &amp; Safety</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://www.ventura.org/rma/planning/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Ventura Co. Planning</h3>
              <p>link</p>
            </div>
          </div>
        </a></div>
      ...
      <div id="sendModal" class="modal">
        <div class="modal-content" style="text-align: center;">
          ...
          <form action="#">
            ...
            <div id="fileOptions"><input type="checkbox" id="5354" class="file-opt" name="link5354" value="5354" checked=""><label for="5354" class="doc-inline-label">Imperial Co. Planning &amp; Dev.</label><br><input type="checkbox" id="5357" class="file-opt" name="link5357" value="5357" checked=""><label for="5357" class="doc-inline-label">Kern Co. Bldg. Inspection</label><br><input type="checkbox" id="5358" class="file-opt" name="link5358" value="5358" checked=""><label for="5358" class="doc-inline-label">Kern Co. Planning &amp; Comm. Dev.</label><br><input type="checkbox" id="5356" class="file-opt" name="link5356" value="5356" checked=""><label for="5356" class="doc-inline-label">LA County Dept. of Public Works</label><br><input type="checkbox" id="5355" class="file-opt" name="link5355" value="5355" checked=""><label for="5355" class="doc-inline-label">OC Bldg. &amp; Planning</label><br><input type="checkbox" id="5359" class="file-opt" name="link5359" value="5359" checked=""><label for="5359" class="doc-inline-label">Riverside Co. Bldg. &amp; Safety</label><br><input type="checkbox" id="5360" class="file-opt" name="link5360" value="5360" checked=""><label for="5360" class="doc-inline-label">San Bernardino Bldg. &amp; Safety</label><br><input type="checkbox" id="5361" class="file-opt" name="link5361" value="5361" checked=""><label for="5361" class="doc-inline-label">San Diego Co. Dept. of Public Works</label><br><input type="checkbox" id="5364" class="file-opt" name="link5364" value="5364" checked=""><label for="5364" class="doc-inline-label">Santa Barbara Co. Planning</label><br><input type="checkbox" id="5362" class="file-opt" name="link5362" value="5362" checked=""><label for="5362" class="doc-inline-label">Ventura Co. Bldg &amp; Safety</label><br><input type="checkbox" id="5363" class="file-opt" name="link5363" value="5363" checked=""><label for="5363" class="doc-inline-label">Ventura Co. Planning</label><br></div>
