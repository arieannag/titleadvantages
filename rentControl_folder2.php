...
<body data-new-gr-c-s-check-loaded="14.997.0" data-gr-ext-installed="">
  ...
  <div class="grid-container" id="grid-container">
    ...
    <main>
      ...
      <h2 id="titleHeader">Rent Control CA</h2>

      <div id="backButton"><button class="button" onclick="location.href='laws_folder.php'">Return to Laws &amp; Propositions</button></div>
      <button class="button" type="button" id="sendModalBtn" style="display: block;">Send Documents In Folder</button>


      <div class="toolbox-wrapper" id="toolboxWrapper"><a href="http://www.ci.berkeley.ca.us/rent/" target="_blank">
        ...
        </a><a href="http://www.beverlyhills.org/citygovernment/departments/communitydevelopment/codecompliance/rentcontrolinformation/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Beverly Hills</h3>
        ...
        </a><a href="http://www.ci.east-palo-alto.ca.us/rentprogram" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>East Palo Alto</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="https://www.hayward-ca.gov/sites/default/files/documents/RRSO%20FAQ.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Hayward</h3>
        ...
        </a><a href="http://hcidla.lacity.org/RSO-Overview" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Los Angeles</h3>
        ...
        </a><a href="http://www.losgatosca.gov/faq.aspx?tid=31" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Los Gatos</h3>
        ...
        </a><a href="http://www2.oaklandnet.com/government/o/hcd/o/RentAdjustment/DOWD008793" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Oakland</h3>
        ...
        </a><a href="http://www.ci.palm-springs.ca.us/government/departments/community-economic-development-department/rent-control" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Palm Springs</h3>
        ...
        </a><a href="mdocs/Rent Control.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Rent Control Cities in CA</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="http://sfrb.org/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>San Francisco</h3>
        ...
        </a><a href="http://www.sanjoseca.gov/index.aspx?NID=1355" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>San Jose</h3>
        ...
        </a><a href="https://www.smgov.net/rentcontrol/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Santa Monica</h3>
        ...
        </a><a href="http://www.weho.org/residents/rent-stabilization-housing" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
      ...
      <div id="sendModal" class="modal">
        <div class="modal-content" style="text-align: center;">
          ...
          <form action="#">
            ...
            <div id="fileOptions"><input type="checkbox" id="6433" class="file-opt" name="link6433" value="6433" checked=""><label for="6433" class="doc-inline-label">Berkeley</label><br><input type="checkbox" id="6431" class="file-opt" name="link6431" value="6431" checked=""><label for="6431" class="doc-inline-label">Beverly Hills</label><br><input type="checkbox" id="6434" class="file-opt" name="link6434" value="6434" checked=""><label for="6434" class="doc-inline-label">East Palo Alto</label><br><input type="checkbox" id="7398" class="file-opt" name="link7398" value="7398" checked=""><label for="7398" class="doc-inline-label">Hayward</label><br><input type="checkbox" id="6429" class="file-opt" name="link6429" value="6429" checked=""><label for="6429" class="doc-inline-label">Los Angeles</label><br><input type="checkbox" id="6436" class="file-opt" name="link6436" value="6436" checked=""><label for="6436" class="doc-inline-label">Los Gatos</label><br><input type="checkbox" id="6437" class="file-opt" name="link6437" value="6437" checked=""><label for="6437" class="doc-inline-label">Oakland</label><br><input type="checkbox" id="6428" class="file-opt" name="link6428" value="6428" checked=""><label for="6428" class="doc-inline-label">Palm Springs</label><br><input type="checkbox" id="6427" class="file-opt" name="file6427" value="6427" checked=""><label for="6427" class="doc-inline-label">Rent Control Cities in CA</label><br><input type="checkbox" id="6438" class="file-opt" name="link6438" value="6438" checked=""><label for="6438" class="doc-inline-label">San Francisco</label><br><input type="checkbox" id="6439" class="file-opt" name="link6439" value="6439" checked=""><label for="6439" class="doc-inline-label">San Jose</label><br><input type="checkbox" id="6432" class="file-opt" name="link6432" value="6432" checked=""><label for="6432" class="doc-inline-label">Santa Monica</label><br><input type="checkbox" id="6430" class="file-opt" name="link6430" value="6430" checked=""><label for="6430" class="doc-inline-label">West Hollywood</label><br></div>
