...
<body style="background: #EBEBEB;">
  ...
  <div class="grid-container" id="grid-container">
    ...
    <main>
      ...
      <center class="shadow">
        <h2>
          Net Advantage Settings
        </h2>
        <BR>
        <P>
        <div style="text-align:center;">
          <div class="costcell">
            <div class="costcellname">Property Tax Rate(%):</div>
            <div class="costcellamount"><input type="text" value="1.25" id="propTaxRate"></input></div>
          </div>
          <div class="costcell">
            <div class="costcellname">Escrow Length(Days):</div>
            <div class="costcellamount"><input type="text" value="90" id="dClosingDays"></input></div>
          </div>
          <div class="costcell">
            <div class="costcellname">Buyer Agent Comission(%):</div>
            <div class="costcellamount"><input type="text" value="3" id="bAgentComm"></input></div>
          </div>
          <div class="costcell">
            <div class="costcellname">Seller Agent Comission(%):</div>
            <div class="costcellamount"><input type="text" value="3" id="sAgentComm"></input></div>
          </div>
          <div class="costcell">
            <div class="costcellname">Default Costs:</div>
            <div class="costcellamount" href=""><input type="button" class="button" value=" Edit " style="font-size: 20px; margin-left: 10px; width: 90px; text-align: center;" onclick="document.location.href='netadvantage_customcosts.php';"></input></div>
          </div>
        </div>
        <BR>
        <P>
          <input type="button" value=" Cancel " class="greybuttons" style="font-size: 12px; margin-right:10px;" onclick="history.back();">
          <input type="button" value=" Save " class="greybuttons" style="font-size: 12px;" onclick="sendupdatedcosts();">
      </center>
    </main>
...
<script>
  function sendupdatedcosts() {
    ...
    var propTaxRate = document.getElementById("propTaxRate").value;
    var dClosingDays = document.getElementById("dClosingDays").value;
    var bAgentComm = document.getElementById("bAgentComm").value;
    var sAgentComm = document.getElementById("sAgentComm").value;
    var addressString = "https://www.titleadvantage.com/mobileproptaxrate_1019.asp?u=Kyle Jonas&id=293272&m=set&ptr=" + propTaxRate + "&dcd=" + dClosingDays + "&bac=" + bAgentComm + "&sac=" + sAgentComm;
    console.log(addressString);
    xhr.open("GET", addressString, true);
    xhr.send();
