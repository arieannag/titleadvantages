...
<body>
  ...
  <div class="grid-container" id="grid-container">
    ...
    <main>
      <!-- incudes? same styling and basic HTML structure as farms.html "my farms" section and "farmInFocus.html" and "farmFocus.html" -->
      <div class="focusFarmsCont" id="focusFarmsCont">
        <h2>Farm Focus </h2>
        <h4>Choose a parent farm below to get started</h4>
        <div class="myFarms" id="myFarms">

          <div class="regFarms" id="regFarms">
            <h3 style="padding-top: 25px;">Farms</h3>
        ...
        <!-- ADDED NEW PARENT FARM BTN * 2/3/20 * -->
        <div class="createNewFocus" id="createNewFocus">
          <a href="farms.php">
            <div class="button" id="createNewParentBtn">Create A New Parent Farm Instead</div>
          </a>
        </div>
