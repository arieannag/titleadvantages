    ...
    <main>
      <div class="backLink" id="backLink">
        <a href="javascript:history.go(-1)">
          < Back to Search Property</a>
      </div>

      <!-- includes? The same formatting/class names as the main properties page -->
<div id="propSearchResults">
    <h2>Couldn't find the property you are looking for. Refine your search and try again.</h2>
</div>
</main>
</div>
</body>
...
<script language="JavaScript">
    function getProperty(index){
      //var js_properties = [];
      //var propaddress = "";
      //if(js_properties[index].propaddress2 == ""){
        //propaddress = js_properties[index].propaddress;
      //}else{
        //propaddress = js_properties[index].propaddress + ", " + js_properties[index].propaddress2;
      //}
      //var postProp = {
        //"propaddress" : propaddress,
        //"propcity" : js_properties[index].propcity,
        //"propstate" : js_properties[index].propstate,
        //"propzip" : js_properties[index].propzip,
        //"propcounty" : js_properties[index].propcounty,
        //"propowner" : js_properties[index].propowner,
        //"propfips" : js_properties[index].propfips,
        //"proplat" : js_properties[index].proplat,
        //"proplon" : js_properties[index].proplon,
      //}
      

      // localStorage.setItem('property', JSON.stringify(postProp));
      // window.open("property-page.php", "_self");
      var formWithID = "prop_form_" + index;
      console.log("submitting form: " + formWithID);
      document.forms[formWithID].submit();
    }
</script>
</html>
