...
<body data-new-gr-c-s-check-loaded="14.997.0" data-gr-ext-installed="">
  ...
  <div class="grid-container" id="grid-container">
    ...
    <main>
      ...
      <h2 id="titleHeader">Consumer Guides</h2>
      ...
      <div class="toolbox-wrapper" id="toolboxWrapper"><a href="mdocs/FSBO Book OCT 2018.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>For Sale By Owner Guide</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/OCT-HomeBuyerSellerGuide_2021_Digital.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Home Buyer &amp; Seller Guide</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a><a href="mdocs/Spanish Buyers Bk App_web.pdf" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/pdf.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Home Buyer Book - Spanish</h3>
              <p>TYPE: file</p>
            </div>
          </div>
        </a></div>
      ...
      <div id="sendModal" class="modal">
        <div class="modal-content" style="text-align: center;">
          ...
          <form action="#">
            ...
            <div id="fileOptions"><input type="checkbox" id="7433" class="file-opt" name="file7433" value="7433" checked=""><label for="7433" class="doc-inline-label">For Sale By Owner Guide</label><br><input type="checkbox" id="8660" class="file-opt" name="file8660" value="8660" checked=""><label for="8660" class="doc-inline-label">Home Buyer &amp; Seller Guide</label><br><input type="checkbox" id="8441" class="file-opt" name="file8441" value="8441" checked=""><label for="8441" class="doc-inline-label">Home Buyer Book - Spanish</label><br></div>
