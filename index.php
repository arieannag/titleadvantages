...
<style type="text/css">
  ...
  span.doc-item-icon {
    background-image: url("img/icon-search-doc.png");
  ...
  span.link-item-icon {
    background-image: url("img/icon-search-link.png");
    background-size: 20px;
    width: 20px;
    height: 20px;
  }
  ...
  span.farm-item-icon {
    background-image: url("img/icon-search-farms.png");
    background-size: 20px;
    width: 20px;
    height: 20px;
  }
  ...
  span.focus-item-icon {
    background-image: url("img/icon-search-focusedfarms.png");
    background-size: 20px;
    width: 20px;
    height: 20px;
  }
  ...
  span.prop-item-icon {
    background-image: url("img/icon-search-property.png");
    background-size: 20px;
    width: 20px;
    height: 20px;
  }
...
<body>
  <div id="topbar">
    <div id="homeCompanyLogo">
      <span id="companyLogo">
        <img src="img/TA-oct.png">
      </span>
    </div>
    <div id="repNameTop">
    ...
    <div class="dropdown" id="dropdown">
      <button onclick="dropdown()" class="dropbtn move-dropbtn" id="dropbtn"><img src="img/user-icon.png" alt="User Icon"></button>
      <div id="userDropdown" class="dropdown-content drop-move home-drop">

        <!-- <a href="userSettings.php">User Settings</a> -->

        <!--
        ADDED ID AND DROPREPPHOTO * 2/07/20 *
        Replace the whole dropdown to be safe Added JS at bottom as well
      -->
  ...
  <div id="customizableBack">
    <img src="backgrounds/" alt="">
  </div>
  <div id="mainNav">
    <h1>Title Advantage</h1>
    <div id="navIcons">

      <a href="properties.php">
        <div class="homenavitem" id="navitem1">
          <svg id="Layer_1" data-name="Layer 1" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 210.13 211.21">
      ...
      <a href="farms.php">
        <div class="homenavitem" id="navitem2">
      ...
      <a href="netadvantage.php" id="navitem3">
        <div class="homenavitem">
          <svg id="Layer_1" data-name="Layer 1" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 210.1 211.16">
            <defs></defs>
      ...
      <a href="calculators.php">
        <div class="homenavitem" id="navitem4">
          <svg id="Layer_1" data-name="Layer 1" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 210.12 211.18">
            <defs></defs>
      ...
      <!-- ADDED More Apps icon and link * 2/10/20 * -->
      <a href="#moreApps">
        <div class="homenavitem" id="navitem1">
          <svg id="Layer_1" data-name="Layer 1" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 209.84 210.04">
  ...
  <div class="flex">
    <div id="repContainer">
      <div id="rep">
        <div id="repPhoto">
          <img src="repphotos/Danny Arguelles.jpg" alt="person">
        </div>
        <div id="repInfo">
          <!-- ADDED IDs TO REP INFO * 1/31/20 * -->
          <h2 id="repName"><a href="contactrep.php">Danny Arguelles</a></h2>
          <h3>Your Representative</h3>
          <p id="repemail">dannya@octitle.com</p>
          <p id="repphonenum">760-337-2988</p>
          <p id="repmobilephonenum">760-604-2232</p>
          <p id="repotherphone"></p>
          <div id="repSocial">
          </div>
        </div>
        ...
        <div id="repContact">
          <!-- ADDDED ID AND JS * 1/31/20 * -->
          <button type="button" name="button" id="emailBtn" onClick="document.location.href='mailto:dannya@octitle.com';">email</button>
          <!-- ADDDED ID * 1/31/20 * -->
        </div>
      </div>
    ...
    <!-- MOVED SEARCH BAR * 1/16/20 * -->
    <div id="mainSearch">
      <div class="innerMainSearch" id="innerMainSearch">
        <!-- Changed header 1/16/20 -->
        <h2>Search your properties and farms</h2>
        <div class="ui-widget">
          <input id="search" type="text">
          <button type="submit" name="button" id="homeSearchBtn">Search</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id="repVideo">
    <div class="repVideoContainer">
      <!-- The source would be determined by what they choose -->
      <!-- If uploaded, src would be apart of the site somewhere? -->
      <iframe src="https://www.youtube.com/embed/3XiQMO0fiVU?rel=0"></iframe>
      <h3 style="text-align: left;padding-top: 20px; text-align: center;">Our Family of Companies Know That Customer Is King</h3>
    </div>
    <div class="videoButtonContainer">
      <a href="more-videos.php">More Videos</a>
    </div>
  </div>
  ...
  <div id="moreAppsContainer">
    <div id="moreApps">
      <h2>More Tools</h2>
      <div class="moreAppsInner" id="moreAppsInner">
        <!-- ADDED LINKS TO ALL BELOW * 1/31/20 * -->
        <a href="docToolbox.php">
          <div class="app" id="docToolbox">
            <h2>Document <br> Toolbox</h2>
          </div>
        </a>
        <a href="https://www.octitle.com/buildcom/hotline?o=oct" target="_blank">
          <div class="app" id="listAndLeads">
            <h2>Investment<br>Hotline</h2>
          </div>
        </a>
        <a href="liveMap.php?u=Kyle Jonas&id=293272&z=99507&o=oct">
          <div class="app" id="liveMap">
            <h2>Live <br> Map</h2>
          </div>
        </a>
        <a href="bkfs_logon_key.php">
          <div class="app" id="listAndLeads">
            <h2>Lists and <br> Leads</h2>
          </div>
        </a>

        <a href="https://www.octitle.com/rates.asp" target="_blank">
          <div class="app" id="listAndLeads">
            <h2>Rate<BR>Calculator</h2>
          </div>
        </a>
        <a href="REDocs.php">
          <div class="app" id="REDocuments">
            <h2>Real Estate<br> Documents</h2>
          </div>
        </a>
        <a href="https://www.octitle.com/openorder.asp?cr=dannya" target="_blank">
          <div class="app" id="escrowOrders">
            <h2>Open<br> Order</h2>
          </div>
        </a>
...
<script>
  ...
  var dbItemsList = [];
  var itemsList = [];
  //get the data as soon as page is loaded.
  window.onload = function() {
    fetchData();
  };

  function textsender() {
    if (document.getElementById("textBtn").innerHTML == "Text Sent") {
      document.getElementById("textBtn").innerHTML = "Text";
    }
    ...
    console.log(sendTextJSON);

    document.getElementById("textBtn").innerHTML = "Sending...";
    textModal.style.display = 'none';
    postData('api_sendTextToRep.php', sendTextJSON)
      .then((data) => {
        console.log(data); // JSON data parsed by `response.json()` call

        if (data.Status == "Thank you. Your message was sent sucessfully.") {
          document.getElementById("textBtn").innerHTML = "Text Sent";
        } else {
          document.getElementById("textBtn").innerHTML = "Trouble sending text at the moment<BR>" + data.Status;
        }
      });
  }
  ...
  function fetchData() {
    fetch('api_getautocompletelist.php')
      .then((response) => {
      ...
      .then((jsonObj) => {
        console.log(jsonObj);
        dbItemsList = jsonObj;
        getAutocompleteItemList(dbItemsList);
  ...
  function getAutocompleteItemList(dbList) {
    var data = dbList.userItems;
  ...
  function showSelection(item) {
    console.log(item.misc + " was selected.");

    if (item.type == "Farm") {
      window.open("regFarmView.php?fid=" + item.value, "_self");
    }

    if (item.type == "Focused Farm") {
      window.open("regFarmView.php?fid=" + item.misc + "&ssid=" + item.value + "&src=child&act=focus&ffnm=" + item.namesolo, "_self");
    }

    if (item.type == "Property") {
      window.open("property-page.php?pid=" + item.value, "_self");
    }

    if (item.type == "Document") {
      //var url = decodeURI(item.misc);
      window.open("docfocus.php?f=" + item.value);
    }

    if (item.type == "Link") {
      //var url = decodeURI(item.misc);
      window.open(item.misc, "_blank");
    }
  }
</script>
