...
<body data-new-gr-c-s-check-loaded="14.997.0" data-gr-ext-installed="">
  ...
  <div class="grid-container" id="grid-container">
    ...
    <main>
      ...
      <h2 id="titleHeader">Data Resources</h2>

      <div id="backButton"><button class="button" onclick="location.href='resourceLib_folder.php'">Return to Resource Library</button></div>
      <button class="button" type="button" id="sendModalBtn" style="display: block;">Send Documents In Folder</button>


      <div class="toolbox-wrapper" id="toolboxWrapper"><a href="https://www.agentpro247.com/index.aspx" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Agentpro247.com</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="https://www.apartmentlists.net/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Apartmentlists.net</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="https://www.attomdata.com/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Attom Data Sources</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://www.car.org/marketdata/data/countysalesactivity/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>CAR Market Trends</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://www.zimas.lacity.org/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>City of LA Boundary map</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="https://www.colerealtyresource.com/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Cole Realty Source</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://www.dqnews.com/Charts/Monthly-Charts/LA-Times-Charts/ZIPLAT.aspx" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Core Logic for resale stats</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://www.countyrecordsresearch.com/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>County Records Research</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="https://dataﬁnder.com/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Data Finder</h3>
        ...
        </a><a href="http://www.defaultresearch.com/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>DefaultResearch.com</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://quickfacts.census.gov" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
        ...
        </a><a href="http://www.ecampaignpros.com/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>eCampaignPro</h3>
        ...
        </a><a href="https://www.infousa.com/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>infoUSA</h3>
        ...
        </a><a href="https://landvoice.com/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>LandVoice</h3>
        ...
        </a><a href="https://www.listsource.com/homepage/index.htm" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>ListSource</h3>
        ...
        </a><a href="http://www.realtyjuggler.com" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Realty Juggler</h3>
              <p>link</p>
            </div>
          </div>
        </a><a href="http://www.rebogateway.com" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>ReboGateway</h3>
        ...
        </a><a href="http://redloc.com/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>REDLOC.com</h3>
        ...
        </a><a href="http://www.retran.net/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>RETRAN.net</h3>
        ...
        </a><a href="http://www.theredx.com/" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>The Red X</h3>
        ...
        </a><a href="http://www.zipmap.net" target="_blank">
          <div class="toolbox-item" id="">
            <div class="tool-icon"><img src="img/link.png" alt="file-icon"></div>
            <div class="tool-title">
              <h3>Zip Code Map</h3>
      ...
      <div id="sendModal" class="modal">
        <div class="modal-content" style="text-align: center;">
          ...
          <form action="#">
            ...
            <div id="fileOptions"><input type="checkbox" id="2898" class="file-opt" name="link2898" value="2898" checked=""><label for="2898" class="doc-inline-label">Agentpro247.com</label><br><input type="checkbox" id="7358" class="file-opt" name="link7358" value="7358" checked=""><label for="7358" class="doc-inline-label">Apartmentlists.net</label><br><input type="checkbox" id="7359" class="file-opt" name="link7359" value="7359" checked=""><label for="7359" class="doc-inline-label">Attom Data Sources</label><br><input type="checkbox" id="2902" class="file-opt" name="link2902" value="2902" checked=""><label for="2902" class="doc-inline-label">CAR Market Trends</label><br><input type="checkbox" id="5075" class="file-opt" name="link5075" value="5075" checked=""><label for="5075" class="doc-inline-label">City of LA Boundary map</label><br><input type="checkbox" id="7360" class="file-opt" name="link7360" value="7360" checked=""><label for="7360" class="doc-inline-label">Cole Realty Source</label><br><input type="checkbox" id="2903" class="file-opt" name="link2903" value="2903" checked=""><label for="2903" class="doc-inline-label">Core Logic for resale stats</label><br><input type="checkbox" id="5081" class="file-opt" name="link5081" value="5081" checked=""><label for="5081" class="doc-inline-label">County Records Research</label><br><input type="checkbox" id="7361" class="file-opt" name="link7361" value="7361" checked=""><label for="7361" class="doc-inline-label">Data Finder</label><br><input type="checkbox" id="5450" class="file-opt" name="link5450" value="5450" checked=""><label for="5450" class="doc-inline-label">DefaultResearch.com</label><br><input type="checkbox" id="5629" class="file-opt" name="link5629" value="5629" checked=""><label for="5629" class="doc-inline-label">Demographic Information</label><br><input type="checkbox" id="7362" class="file-opt" name="link7362" value="7362" checked=""><label for="7362" class="doc-inline-label">eCampaignPro</label><br><input type="checkbox" id="7363" class="file-opt" name="link7363" value="7363" checked=""><label for="7363" class="doc-inline-label">infoUSA</label><br><input type="checkbox" id="7364" class="file-opt" name="link7364" value="7364" checked=""><label for="7364" class="doc-inline-label">LandVoice</label><br><input type="checkbox" id="7365" class="file-opt" name="link7365" value="7365" checked=""><label for="7365" class="doc-inline-label">ListSource</label><br><input type="checkbox" id="4216" class="file-opt" name="link4216" value="4216" checked=""><label for="4216" class="doc-inline-label">Realty Juggler</label><br><input type="checkbox" id="7366" class="file-opt" name="link7366" value="7366" checked=""><label for="7366" class="doc-inline-label">ReboGateway</label><br><input type="checkbox" id="5084" class="file-opt" name="link5084" value="5084" checked=""><label for="5084" class="doc-inline-label">REDLOC.com</label><br><input type="checkbox" id="5085" class="file-opt" name="link5085" value="5085" checked=""><label for="5085" class="doc-inline-label">RETRAN.net</label><br><input type="checkbox" id="7367" class="file-opt" name="link7367" value="7367" checked=""><label for="7367" class="doc-inline-label">The Red X</label><br><input type="checkbox" id="5646" class="file-opt" name="link5646" value="5646" checked=""><label for="5646" class="doc-inline-label">Zip Code Map</label><br></div>
